...
<div id="page-wrap">
    ...
    <ul style="list-style-type:none">
      <li>1. <a accesskey="alt+1" href="#Q1">What can I use the Metrics Monitoring Tool (MMT) for?</a></li>
      <li>2. <a accesskey="alt+2" href="#Q2">How do I get started?</a></li>
      <li>3. <a accesskey="alt+3" href="#Q3">I forgot my password. How do I get a new one?</a></li>
      <li>4. <a accesskey="alt+4" href="#Q4">How can I change my password?</a></li>
      <li>5. <a accesskey="alt+5" href="#Q5">As a project manager, how do I do the weekly reporting of my project?</a></li>
      <li>6. <a accesskey="alt+6" href="#Q6">How do I log my daily working time?</a></li>
      <li>7. <a accesskey="alt+7" href="#Q7">How can I view the progress of my project?</a></li>
      <li>8. <a accesskey="alt+8" href="#Q8">How can I view the progress of other projects?</a></li>
    </ul>
	
    <h2 id="Q1">1. What can I use the Metrics Monitoring Tool (MMT) for?</h2>
    <p>
    ...
    <h2 id="Q2">2. How do I get started?</h2>
    <p>
    ...
    <h2 id="Q3">3. I forgot my password. How do I get a new one?</h2>
    <p>
    ...
    <h2 id="Q4">4. How can I change my password/edit my profile?</h2>
    <p>
    ...
    <h2 id="Q5">5. As a project manager, how do I do the weekly reporting of my project?</h2>
    <p>
    ...
    <h2 id="Q6">6. How do I log my daily working time?</h2>
    <p>
    ...
    <h2 id="Q7">7. How can I view the progress of my project?</h2>
    <p>
    ...
    <h2 id="Q8">8. How can I view the progress of other projects?</h2>
    <p>
